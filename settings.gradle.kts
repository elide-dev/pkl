...
JavaVersion.current().let { toolchain ->
  require(toolchain.isCompatibleWith(JavaVersion.VERSION_21)) {
    "Project requires Java 21+ to build, but found ${toolchain.majorVersion}."
  }
}
